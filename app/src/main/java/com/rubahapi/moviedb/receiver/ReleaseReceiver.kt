...
class ReleaseReceiver:BroadcastReceiver(){
    companion object{
        ...
        val EXTRA_MESSAGE_RELEASE = "message"
        val EXTRA_TYPE_RELEASE = "type"
    }
    ...
    private fun showAlarmNotification(
        ...
        val builder = NotificationCompat.Builder(context, CHANNEL_ID)
            ...
            .setContentText("Catalogue Movie Missing Youtesttst")
    ...
    fun setRepeatingAlarm(context: Context, type: String, time: String, message: String, repeatingID: Int) {
    ...
    fun cancelAlarm(context: Context, type: String, repeatingID: Int) {
        val alarmManager = context.getSystemService(Context.ALARM_SERVICE) as AlarmManager
        val intent = Intent(context, NotifReceiver::class.java)
        val requestCode = repeatingID
